...
public class GrayRender implements RenderImpl {
    ...
    private final String fsOES = ""
            ...
            + "    float gray = originColor.x*0.3 + originColor.y*0.59 + originColor.z*0.11;\n"
            + "    gl_FragColor = vec4(gray, gray, gray, originColor.w);\n"
            + "}";
